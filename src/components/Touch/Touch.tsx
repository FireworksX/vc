...
export default Vue.extend({
  ...
  methods: {
    ...
    onMove(e: any & VCUITouchEvent) {
      ...
      if (isPressed) {
        ...
        if (!isY && !isX) {
          ...
          const willBeSlidedX = willBeX && (this.onPropMoveX !== undefined || this.onPropMove !== undefined)
          const willBeSlidedY = willBeY && (this.onPropMoveY !== undefined || this.onPropMove !== undefined)
    ...
    getRootRef() {
      if (this.$listeners.rootRef !== undefined && typeof this.$listeners.rootRef === 'function') {
