...
export default Vue.extend({
  ...
  render(h: any) {
    ...
    return (
      <vc-form-field
        tag='label'
        class={[this.classNames, !value ? 'vc-Select--not-selected' : '', `vc-Select--align-${align}`, className]}
        style={style}
        status={status}
        top={top}
        bottom={bottom}
      >
        <select class='vc-Select__el' onChange={this.emitValue} value={value} disabled={disabled}>
