...
export default Vue.extend({
  ...
  methods: {
    ...
    onTouchMove(e: any) {
      ...
      if (watching && touchDown) {
        ...
        const currentY = Math.max(start, Math.min(PARAMS.maxY, start + shift * positionMultiplier))
  ...
  render(h: any) {
    ...
    return (
      <touch onStart={this.onTouchStart} onMove={this.onTouchMove} onEnd={this.onTouchEnd} class={this.classNames}>
