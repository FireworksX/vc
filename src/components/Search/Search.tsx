        ...
        <div class='vc-Search__in'>
          ...
          <div class='vc-Search__control'>
            <input
              ...
              ref='searchinput'
            />
            {this.$slots.after && <div class='vc-Search__after-width'>{this.$slots.after}</div>}

            <div class='vc-Search__placeholder'>
              <div class='vc-Search__placeholder-in'>
                <vc-icon-search size={16} />
                <div class='vc-Search__placeholder-text'>{this.value ? '' : placeholder || 'Поиск'}</div>
              </div>
            </div>
          </div>
          <div class='vc-Search__after' onclick={this.onCancel}>
            ...
            {this.$slots.after && <div class='vc-Search__after-in'>{this.$slots.after}</div>}
          </div>
        </div>
      </div>
    )
